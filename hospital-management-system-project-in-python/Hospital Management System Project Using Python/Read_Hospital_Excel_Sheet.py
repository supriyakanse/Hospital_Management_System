def Read_Patients_DataBase() :
	...
	myfile = open(r"hospital-management-system-project-in-python/Patients_DataBase.csv")
...
def Read_Doctors_DataBase () :
	...
	myfile = open (r"hospital-management-system-project-in-python\Doctors_DataBase.csv")
